...
namespace RestaurantTask.Migrations
{
    ...
    [Migration("20231030134127_Initial8")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantTask.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RestaurantTask.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantTask.Models.Reservation", b =>
                {
                    b.HasOne("RestaurantTask.Models.RestaurantTable", "RestaurantTable")
                        .WithMany("Reservations")
                        .HasForeignKey("RestaurantTableId");

                    b.HasOne("RestaurantTask.Models.AppUser", "User")
                        .WithMany("Reservations")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("RestaurantTask.Models.RestaurantTable", b =>
                {
                    b.HasOne("RestaurantTask.Models.Restaurant", "Restaurant")
